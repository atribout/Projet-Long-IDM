 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.xtext.game.Objet#getName <em>Name</em>}</li>
 *   <li>{@link fr.n7.xtext.game.Objet#getTaille <em>Taille</em>}</li>
 *   <li>{@link fr.n7.xtext.game.Objet#getQuantite <em>Quantite</em>}</li>
 * </ul>
 *
...
public interface Objet extends EObject
{
   ...
   * @see #setName(String)
   * @see fr.n7.xtext.game.GamePackage#getObjet_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link fr.n7.xtext.game.Objet#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setQuantite(int)
   * @see fr.n7.xtext.game.GamePackage#getObjet_Quantite()
   * @model
   * @generated
   */
  int getQuantite();
  ...
  /**
   * Sets the value of the '{@link fr.n7.xtext.game.Objet#getQuantite <em>Quantite</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
