 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.xtext.game.impl.ActionImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.n7.xtext.game.impl.ActionImpl#getObjetsConsommes <em>Objets Consommes</em>}</li>
 *   <li>{@link fr.n7.xtext.game.impl.ActionImpl#getObjetDonnes <em>Objet Donnes</em>}</li>
 *   <li>{@link fr.n7.xtext.game.impl.ActionImpl#getObjetsDonnes <em>Objets Donnes</em>}</li>
