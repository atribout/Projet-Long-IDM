 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.xtext.game.Chemin#getLieu1 <em>Lieu1</em>}</li>
 *   <li>{@link fr.n7.xtext.game.Chemin#getLieu2 <em>Lieu2</em>}</li>
 *   <li>{@link fr.n7.xtext.game.Chemin#getActions <em>Actions</em>}</li>
 *   <li>{@link fr.n7.xtext.game.Chemin#getConditionsOuverture <em>Conditions Ouverture</em>}</li>
 * </ul>
 *
...
public interface Chemin extends Conditionnel
{
   ...
   * @see #setLieu1(Lieu)
   * @see fr.n7.xtext.game.GamePackage#getChemin_Lieu1()
   * @model
   * @generated
   */
  Lieu getLieu1();
  ...
  /**
   * Sets the value of the '{@link fr.n7.xtext.game.Chemin#getLieu1 <em>Lieu1</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setLieu2(Lieu)
   * @see fr.n7.xtext.game.GamePackage#getChemin_Lieu2()
   * @model
   * @generated
   */
  Lieu getLieu2();
  ...
  /**
   * Sets the value of the '{@link fr.n7.xtext.game.Chemin#getLieu2 <em>Lieu2</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.n7.xtext.game.GamePackage#getChemin_Actions()
   * @model
   * @generated
   */
   ...
   * @see fr.n7.xtext.game.GamePackage#getChemin_ConditionsOuverture()
   * @model
   * @generated
   */
