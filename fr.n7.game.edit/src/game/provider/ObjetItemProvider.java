...
/**
 * This is the item provider adapter for a {@link game.Objet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GamePackage.Literals.OBJET__NAME,
				 true,
				 false,
				 false,
	...
	protected void addQuantitePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Objet_quantite_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Objet_quantite_feature", "_UI_Objet_type"),
				 GamePackage.Literals.OBJET__QUANTITE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
