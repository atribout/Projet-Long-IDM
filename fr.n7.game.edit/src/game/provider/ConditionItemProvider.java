...
/**
 * This is the item provider adapter for a {@link game.Condition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionItemProvider extends JeuElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addConnaissancePropertyDescriptor(object);
		}
	...
	protected void addNegationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Condition_negation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Condition_negation_feature", "_UI_Condition_type"),
				 GamePackage.Literals.CONDITION__NEGATION,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Connaissance feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addConnaissancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Condition_connaissance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Condition_connaissance_feature", "_UI_Condition_type"),
				 GamePackage.Literals.CONDITION__CONNAISSANCE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GamePackage.Literals.CONDITION__OBJET);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.CONDITION__OBJET,
