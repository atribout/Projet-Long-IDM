 ...
 * </p>
 * <ul>
 *   <li>{@link game.impl.ChoixImpl#getTexte <em>Texte</em>}</li>
 *   <li>{@link game.impl.ChoixImpl#getActions <em>Actions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChoixImpl extends ConditionnelImpl implements Choix {
	/**
	...
	public EList<Action> getActions() {
		if (actions == null) {
			actions = new EObjectResolvingEList<Action>(Action.class, this, GamePackage.CHOIX__ACTIONS);
		}
		return actions;
	}
